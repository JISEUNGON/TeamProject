...
public class MapMarkerManager {
    ...
    private final String[] stations = new String[]{"명지대", "상공회의소", "진입로", "명지대역", "진입로(명지대방향)", "이마트", "동부경찰서", "용인시장", "중앙공영주차장"};
    ...
    public void setMarkers(boolean city, boolean station) {
        ...
        if (city && station) {
            ...
            targetStations = new String[]{"명지대", "상공회의소", "진입로", "진입로(명지대방향)", "이마트", "동부경찰서", "용인시장", "중앙공영주차장"};
        } else if (!city && station) {
            targetStations = new String[]{"명지대", "상공회의소", "진입로", "명지대역", "진입로(명지대방향)", "이마트"};
        } else {
            return;
        }
